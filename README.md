...
- La funcionalidad es posible, ya que el dataset de películas tiene descripciones textuales que son convertidas a *embeddings* que posteriormente son insertados a la base de datos, permitiendo el cálculo de distancias entre los *embeddings* de las descripciones originales de las películas del dataset, y los *embeddings textuales* que ingresa el usuario. 
